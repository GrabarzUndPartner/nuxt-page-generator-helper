...
import { isDynamicMode, isNuxtBuild, isNuxtGenerate, isNuxtTest, addPlugins, getNuxtI18nModule, extendBuild, extendRoutes, resolveAdapter } from './utils/module'
...
function getDefaultOptions (options, isDev) {
  return Object.assign({ isDev }, {
    ...
    /**
     * Specifies the number of components assigned to the page chunk.
     * Important: Only active if `asyncComponentLoad` is set.
     */
    asyncComponentMaxEager: 1,
    /**
